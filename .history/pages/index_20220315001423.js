...
export default function Home() {
  let ctx_out, video_in, ctx_tmp, c_tmp, c_out, test, video;
  ...
  useEffect(() => {
    ...
    await rawVideo.current.play();
    video = document.getElementById('video');
    video.addEventListener("play", transform)
  }, []);
    ...
    <>
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="column">
            <img id="loading" width="50" height="30" src="https://mir-s3-cdn-cf.behance.net/project_modules/disp/f1055231234507.564a1d234bfb6.gif" /><br />
